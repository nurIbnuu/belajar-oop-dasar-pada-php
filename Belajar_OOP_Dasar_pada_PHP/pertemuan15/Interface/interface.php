...
// Visibility (Acces Modifier)
  ...
  // Mengapa harus pakai Setter dan Getter, supaya bisa melakukan sesuatu di dalam method Setter atau Getter(misal Validasi yang boleh diinputkan hanya string)
      ...
      // Kelas abstrak minimal memiliki 1 method abstrak



  // Interface
    # 'Kelas Abstrak' yang sama sekali tidak memiliki implementasi; semua method hanya definisinya saja.
    # Murni merupakan templateruntuk kelas turunannya.
    ...
    # Dengan menggunakan type-hinting dapat melakukan 'Dependency Injection'; type-hinting == object type; sebuah method untuk menerima parameter object
    # Pada akhirnya akan mencapai Polymorphism

  
  // Contoh Interface/template
/*   interface Buah {
    // hanya punya deklarasi method, tanpa implementasi
    // tidak boleh punya property
    // tidak bisa diinstansiasi
    public function makan(); // deklarasi method
    public function setWarna($warna); // deklarasi method
  }
  interface Benda {
  ...
  class Apel implements Buah, Benda {
    protected $warna; // propertynya di sini
    protected $ukuran; // propertynya di sini

    // konsekuensinya harus menuliskan method dari interface untuk diimplementasi

    public function makan() {
      // ini implementasi
      // method minimal sama dengan yang di interface boleh lebih
    }
  ...
  class Jeruk implements Buah {
    ...
    Interface juga keputusan desain  
  */
